...
<section class="content">
   ...
   <div class="card card-info">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form class="form-horizontal" action="{{route('classroom.update',$detail->id)}}" method="post">
      {{csrf_field()}}
      ...
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="text" name="classroom_code" class="form-control" value="{{$detail->classroom_code}}">
        </div>
        <div class="form-group">
